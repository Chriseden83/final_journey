        ...
        <div className="guide-container">
          ...
          <div className="guide-section" id="immediate">
            ...
            <div className="guide-card">
              ...
              <p>
                Contact your doctor no matter what time of day it is. They will
                arrange to come and confirm death, issuing you with a
                &apos;medical certificate&apos; to confirm the cause of death.
                The person&apos;s body cannot be moved until this has happened.
              </p>
              <p>
            ...
            <div className="guide-card">
              ...
              <ul>
                ...
                <li>
                  If they are on a pressure relieving mattress, this can be left
                  on
                </li>
                <li>
          ...
          <div className="guide-section" id="registration">
            ...
            <div className="guide-card">
              ...
              <p>
                ...
                of the date of death, unless the Registrar says this period may
                be extended or if the coroner is involved. The registration
                itself will take approximately 30 minutes.
              </p>
              <p>
                ...
                card, birth certificates, marriage certificates) that relate to
                the person who has died.
              </p>
              <p>
                <em>
                  If you are upset, the Registrar will understand and will give
            ...
            <div className="guide-card">
              ...
              <ul>
                <li>
                  ...
                  for burial or cremation. Give this to the Funeral Directors or
                  directly to the burial/cremation authorities.
                </li>
                <li>
                ...
                <li>
                  <strong>Death certificates</strong> &ndash; may be required by
                  banks, building societies, solicitors, insurance and pension
                  claims. Cost approximately £11 each at time of registration.
                </li>
              </ul>
          ...
          <div className="guide-section" id="funeral-director">
            ...
            <div className="guide-card">
              <p>
                ...
                organise the funeral yourself. You may want to use some but not
                all of a funeral director&apos;s services.
              </p>
              <p>
                It is important to choose someone that you trust and understands
                what it is you want, so you may want to call around different
                organisations before you decide.
              </p>
            </div>
            ...
            <div className="guide-card guide-card-branded">
              ...
              <p>
                At Final Journey we welcome such enquiries. We can help as much
                or as little as you want. Whether it is help with transport from
                A-B, supplying a coffin, through to organising all aspects of
                the funeral.
              </p>
              <ul>
                <li>
                ...
                <li>
                  We will meet with you to discuss arrangements at your home or
                  at our office
                </li>
              </ul>
          ...
          <div className="guide-section" id="organising">
            ...
            <div className="guide-card">
              <p>
                ...
                improved by professionals. Your funeral needs to be created and
                conducted according to the culture, customs and language of your
                family. You have choices:
              </p>
              <ul>
                <li>
            ...
            <div className="options-grid">
              <div className="option-card">
                ...
                <h4>Transport</h4>
                <p>
                  Choose our Gold Mercedes Vito hearse, traditional hearse with
                  limousines, motorcycle hearse, VW Campervan, horse and cart,
                  or your own vehicle.
                </p>
              ...
              <div className="option-card">
                ...
                <h4>Music</h4>
                <p>
                  Most crematoriums have the Wesley music system with access to
                  almost anything ever recorded. Live music also works
                  beautifully.
                </p>
              </div>
              ...
              <div className="option-card">
                ...
                <p>
                  Services can be recorded or filmed. We can arrange photography
                  to help you remember everyone who attended.
                </p>
              </div>
            ...
            <div className="guide-card">
              ...
              <ul>
                ...
                <li>
                  <strong>Put something on the coffin</strong> &ndash; a single
                  flower stem, a sprig of herb, or a last message
                </li>
                <li>
                  <strong>Funeral favours</strong> &ndash; give guests a little
                  keepsake: seeds to plant, a favourite recipe, something that
                  belonged to the person
                </li>
                <li>
                  <strong>Raise a toast</strong> &ndash; consider sharing their
                  favourite sweet or raising a glass at the goodbye moment
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="guide-section" id="notify">
            ...
            <div className="guide-card">
              <p>
                When someone dies you will need to contact various organisations
                to inform them. You may need to send them a death certificate:
              </p>
              ...
              <p className="guide-tip">
                <strong>Tell Us Once:</strong> This government service helps you
                notify multiple departments at once. The registrar will provide
                this form when you register the death.
              </p>
              <p className="guide-tip">
      ...
      <section className="guide-cta">
        <div className="guide-cta-content">
          ...
          <div className="guide-cta-buttons">
            ...
            <a href="tel:01228595060" className="btn-secondary guide-phone-btn">
