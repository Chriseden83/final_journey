...
export default function AnimatedGriefChatContent() {
  return (
    <>
              ...
              <div className="guide-section">
                <div className="guide-card">
                  <p className="mb-4 text-lg leading-relaxed text-(--text-secondary)">
                    Most people expect to be very upset or distressed when
                    someone close to them has died. What takes many people by
                    surprise is how strong the emotions can be, how they can
                    change very quickly, and how long they last.
                  </p>
                  <p className="mb-4 text-lg leading-relaxed text-(--text-secondary)">
                    People around you may seem to think you should be &apos;back
                    to normal&apos; after a few weeks or months. You might
                    appear to be your usual self to other people, but you know
                    that on the inside, you&apos;re not even sure what normal is
                    anymore.
                  </p>
                  <p className="mb-4 text-lg leading-relaxed text-(--text-secondary)">
                    ...
                    Sometimes, however, it can seem that life is more difficult
              ...
              <div className="guide-section">
                ...
                <div className="guide-card guide-card-branded">
                  <p className="mb-4">
                    ...
                    the chat box in the bottom right corner of this page, you
                    can chat directly to a specially trained bereavement
                    counsellor.
                  </p>
                  <p className="mb-6">
                    GriefChat counsellors are experienced in supporting bereaved
                    people and will listen to your story, explore how your grief
                    is affecting you, and help you to find any additional
              ...
              <div className="guide-section">
                ...
                <div className="options-grid">
                  ...
                  <div className="option-card">
                    ...
                    <p>
                      Learn about the full range of support we provide to
