  ...
  return (
    <main className="about-page">
      ...
      <section className="about-intro">
        <div className="about-container">
          <div className="about-intro-grid">
            ...
            <FadeInRight delay={0.3} className="about-intro-content">
      ...
      <section className="about-mission">
        <div className="about-container">
          <FadeInUp className="about-mission-content">
      ...
      <section className="about-values">
        <div className="about-container">
          ...
          <StaggerContainer className="about-values-grid" staggerDelay={0.1}>
      ...
      <section className="about-differentiators">
        <div className="about-container">
          ...
          <StaggerContainer className="about-stats-grid" staggerDelay={0.1}>
      ...
      <section className="about-team">
        <div className="about-container">
          <div className="about-team-grid">
            <FadeInLeft delay={0.2} className="about-team-content">
      ...
      <section className="about-accreditations">
        <div className="about-container">
          ...
          <StaggerContainer
            className="about-accreditations-grid"
            staggerDelay={0.1}
          >
            {accreditations.map((accreditation, index) => (
              <StaggerItem key={index}>
                <div className="about-accreditation-card">
      ...
      <section className="about-cta">
        <div className="about-container">
          <FadeInUp className="about-cta-content">
